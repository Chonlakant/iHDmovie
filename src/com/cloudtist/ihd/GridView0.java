...
public class GridView0 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		aq.ajax(url1, JSONObject.class, this, "getJson1");
		aq.ajax(url2, JSONObject.class, this, "getJson2");
		aq.ajax(url3, JSONObject.class, this, "getJson3");
		aq.ajax(url4, JSONObject.class, this, "getJson4");
	}
	...
	public void getJson1(String url, JSONObject jo, AjaxStatus status)
			throws JSONException {
	...
	public void getJson2(String url, JSONObject jo, AjaxStatus status)
			throws JSONException {
	...
	public void getJson4(String url, JSONObject jo, AjaxStatus status)
			throws JSONException {
	...
	public void getJson3(String url, JSONObject jo, AjaxStatus status)
			throws JSONException {
